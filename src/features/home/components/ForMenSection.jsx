  ...
  return (
    <section className="bg-black overflow-hidden h-auto md:h-[341px]">
      <div className="flex flex-col md:flex-row items-center h-full w-full">
        ...
        {/* Left Side - Text */}
        <div className="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-10 py-8 md:py-0 h-auto md:h-full relative overflow-hidden">
          {/* Decorative crystal image bottom-left */}
          <img
            src="/home/shiny-diamond.svg"
            alt=""
            className="absolute hidden md:flex -bottom-10 -left-10 w-48 h-48 rotate-12 object-contain pointer-events-none select-none"
            loading="lazy"
          />

          {/* Heading inline with diamond + line */}
          <div className="flex items-center relative z-10 gap-2 md:ml-24">
            <h2 className="text-2xl md:text-[30px] font-heading text-white font-normal leading-tight md:leading-[66px] -tracking-[2%]">
              For Men who move different
            </h2>
            <div className="hidden md:flex flex-row items-center">
              <span className="text-white text-[16px] shrink-0">&#9670;</span>
              <div className="flex-1">
                <img src="/home/Line-right-white.svg" loading="lazy" />
              </div>
            </div>
          </div>

          {/* Subtitle */}
          <p className="text-white/70 text-[12px] tracking-[12%] leading-[24px] md:leading-[33px] uppercase relative z-10 mt-1 md:ml-24">
        ...
        <div className="w-full md:w-1/2 overflow-hidden h-64 md:h-full flex items-center">
          <div
            ref={scrollRef}
            className="flex gap-4 overflow-x-auto scrollbar-hide select-none px-6 h-full items-center"
