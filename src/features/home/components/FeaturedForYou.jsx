...
function FeaturedProductCard({ product }) {
  const [imgSrc, setImgSrc] = useState(product.image || "/home/featured/image.svg");
...
export default function FeaturedForYou({ products = [] }) {
  ...
  return (
    <section className="py-8 md:py-12 bg-white">
      <div className="max-w-8xl mx-auto px-4  md:px-6">
        {/* Header */}
        <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between mb-8 md:mb-10">
          <div>
            {/* Title row */}
            <div className="flex items-center gap-2 mb-2">
              <h2 className="font-heading text-2xl md:text-[33px] text-charcoal leading-[66px] -tracking-[2%]">
                Featured for you
              </h2>
