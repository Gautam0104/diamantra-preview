...
export default function GoldChains({ cmsData }) {
  ...
  return (
    <section className="py-8 md:py-12 bg-white">
      <div className="max-w-7xl mx-auto px-2  md:px-4">
        <div
          className="relative rounded-2xl overflow-hidden flex items-center justify-center h-40 sm:h-40 md:h-[249px]"
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-4 md:gap-8">
            ...
            <img
              src={modelImage}
              alt="Gold Chains"
              className="h-40 sm:h-40 md:h-[249px] w-auto object-contain flex-shrink-0"
              loading="lazy"
            />
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <h2 className="font-heading text-xl sm:text-2xl md:text-[57px] text-white font-normal leading-tight md:leading-[48px] tracking-[0%] mb-1 md:mb-2">
                {headingLine1}
