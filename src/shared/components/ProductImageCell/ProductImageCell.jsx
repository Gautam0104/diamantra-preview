  ...
  return (
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        {hasMedia ? (
          ...
          <DialogTrigger asChild>
            <div className="relative aspect-square w-20 border border-dashed rounded flex items-center justify-center cursor-pointer hover:bg-gray-100">
        ...
        <DialogContent className="sm:max-w-[625px] max-h-[73vh] overflow-y-auto">
          <DialogTitle className="text-lg font-medium mb-4 hidden">
            Manage Media for {item.products?.name}
          </DialogTitle>
          <ImageGalleryDialog
