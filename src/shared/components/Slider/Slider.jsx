  ...
  const images = [
    {
      ...
      description:
        "A stunning diamond necklace with a graceful pendant, adding elegance and brilliance to your ensemble.",
    },
    {
      src: "/admin/J1.webp",
      alt: "Elegant Solitaire Diamond Ring",
      description:
        "Timeless solitaire diamond ring featuring a flawless cut stone set in a sleek white gold band — perfect for engagements or anniversaries.",
    },
    {
      src: "/admin/j7.jpg",
      alt: "Diamond Earrings",
      description:
        "Exquisite diamond earrings with a delicate design, offering a touch of sophistication and sparkle for any occasion.",
    },
    ...
    },
    {
      ...
      alt: "Diamond Pendant",
      description:
        "A beautifully crafted diamond pendant, perfect for adding a touch of timeless elegance to any outfit.",
    },
  ];
  ...
  return (
    <aside className=" hidden xl:flex flex-col xl:w-[510px] mx-auto  2xl:w-full ">
      <div className="flex relative flex-col h-[400px] xl:h-[500px] 2xl:h-[500px] overflow-hidden grow aspect-square pt-40 rounded-md  md:w-full">
        ...
        />
        <div className="flex relative flex-col px-4 pt-64 pb-4 w-full rounded-xl max-md:pt- max-md:pr-5 max-md:max-w-full ">
          <div className="flex gap-5 justify-between  w-full max-md:max-w-full">
            <p className="mr-7 text-sm leading-6 text-black max-md:mr-2.5 max-md:max-w-full">
